...
export default function BalloonTemplate({ card, themeColor, profile, profileButtonColor, profileLinkColor, user, baseUrl }) {
  ...
  const handleDownload = () => {
    ...
    if (profile.profile_theme_type === 'balloon' && profile.profile_img_cover_balloon !== '/storage/') {
      cover =  `${baseUrl}/${profile.profile_img_cover_balloon}`;
    } else {
  ...
  return (
    <>
      <div className={`balloon-template ${themeColor} p-8 h-full`}>

        <div className={"ps-header-fe"}>
          <aside className="relative flex transition-width bg-transparent z-10 min-h-10">

            <div className="absolute left-1/2 transform -translate-x-1/2">
              <div className="flex rounded-full">
                <img
                  src={
                    profile.profile_img_cover_balloon === '/storage/'
                      ? "/storage/image/0/icon-fallback-logo-backend.png"
        ...
        <div className="ps-container-fe mt-4 flex flex-col">

          <div className="relative w-64 h-64 rounded-full overflow-hidden border-1 mt-8 mb-5 mx-auto" style={{borderColor: '#D6D6D6'}}>
            <img
          ...
          <p className={`text-center font-medium text-medium leading-3 ps-text-${themeColor}`}>
            {profile.profile_title}
          </p>
          <p className={`text-center font-medium text-[1.7rem] ps-text-${themeColor}`}>
            {profile.profile_name} {profile.profile_lastname}
          </p>
          <p className={`text-center font-medium text-base ps-text-${themeColor}`}>
            {profile.profile_role}
          </p>
          <p className={`text-center font-medium text-lg ps-text-${themeColor}`}>
            ...
            {profile.social_networks.map((social) => {
              ...
              return (
                <a
                  ...
                  className="w-16 h-16 rounded-full flex flex-shrink-0 items-center justify-center"
                  style={{backgroundColor: profileButtonColor, color: 'white'}}
                >
                  <img
                    src={iconPath}
          ...
          <div className={"flex gab-3 mt-12"}>
            <ProfileAccordionFE
              profile={profile}
        ...
        <div className={"ps-footer-fe mt-4 flex ml-auto flex-row"}>
